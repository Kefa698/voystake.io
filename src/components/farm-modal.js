...
import { setLPStake, setLPUnStake } from "../store/actions/wallet";
        ...
        <>
            ...
            <div className='mt-1'>
                ...
                <button className="btn b-p-1 br-8 mt-2 m-s-btn" onClick={()=>{
                    ...
                    con.buttonText === 'Stake' ? dispatch(setLPStake(props.web3, props.account, props.pair.id, props.pair.pair, val)) : dispatch(setLPUnStake(props.web3, props.account, props.pair.id, val))
...
const mapDispatchToProps = () => {
    return {
      setLPStake: setLPStake,
      setLPUnStake: setLPUnStake,
    }
}
