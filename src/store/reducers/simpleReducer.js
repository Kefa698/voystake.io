import { CONNECT_WALLET, DISCONNECT_WALLET, GET_BALANCEOFREWARDS, GET_HISTORY, SPINNER_SHOW, TOAST_SHOW } from '../actions/actionType';
    ...
    switch(action.type) {
        case CONNECT_WALLET:
            return {
                ...
                voyValue: action.payload.voyValue,
